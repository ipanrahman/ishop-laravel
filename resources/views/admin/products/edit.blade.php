                ...
                <form action="{{ route('admin.products.update',$products->id) }}" enctype="multipart/form-data"
                    ...
                    <div class="from-group mt-4">
                        ...
                        <select name="category" class="form-control">
                            <option hidden value="{{$products->category()->first()->id}}">
                                {{$products->category()->first()->name}}</option>
                    ...
                    <a href="{{ route('admin.products.index') }}" class="btn btn-primary"><i class="fas fa-undo"></i>
                        Back</a>
                </form>
            </div>
        </div>
